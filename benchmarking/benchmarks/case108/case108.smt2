...
(define-fun $e308 () (_ BitVec 1) (ite (= stbusy_0 stbusy_1) #b1 #b0))
(define-fun $e309 () (_ BitVec 1) (bvand startselftest_0 (bvnot stbusy_1)))
(define-fun $e310 () (_ BitVec 1) (bvand (bvnot startselftest_0) (bvnot $e308)))
(define-fun $e311 () (_ BitVec 1) (bvand (bvnot $e309) (bvnot $e310)))
(define-fun $e312 () (_ BitVec 1) (bvand compareover_in_1 stbusy_1))
(define-fun $e313 () (_ BitVec 1) (bvand (bvnot compareover_in_1) (bvnot $e308)))
(define-fun $e314 () (_ BitVec 1) (bvand (bvnot $e312) (bvnot $e313)))
(define-fun $e315 () (_ BitVec 1) (bvand $e55 (bvnot $e314)))
(define-fun $e316 () (_ BitVec 1) (bvand stbusy_1 (bvnot $e55)))
(define-fun $e317 () (_ BitVec 1) (bvand (bvnot $e315) (bvnot $e316)))
(define-fun $e318 () (_ BitVec 1) (bvand $e20 (bvnot $e308)))
(define-fun $e319 () (_ BitVec 1) (bvand (bvnot $e20) (bvnot $e317)))
(define-fun $e320 () (_ BitVec 1) (bvand (bvnot $e318) (bvnot $e319)))
(define-fun $e321 () (_ BitVec 1) (bvand $e19 (bvnot $e308)))
(define-fun $e322 () (_ BitVec 1) (bvand (bvnot $e19) (bvnot $e320)))
(define-fun $e323 () (_ BitVec 1) (bvand (bvnot $e321) (bvnot $e322)))
(define-fun $e324 () (_ BitVec 1) (bvand $e18 (bvnot $e308)))
(define-fun $e325 () (_ BitVec 1) (bvand (bvnot $e18) (bvnot $e323)))
(define-fun $e326 () (_ BitVec 1) (bvand (bvnot $e324) (bvnot $e325)))
(define-fun $e327 () (_ BitVec 1) (bvand $e17 (bvnot $e308)))
(define-fun $e328 () (_ BitVec 1) (bvand (bvnot $e17) (bvnot $e326)))
(define-fun $e329 () (_ BitVec 1) (bvand (bvnot $e327) (bvnot $e328)))
(define-fun $e330 () (_ BitVec 1) (bvand $e16 (bvnot $e308)))
(define-fun $e331 () (_ BitVec 1) (bvand (bvnot $e16) (bvnot $e329)))
(define-fun $e332 () (_ BitVec 1) (bvand (bvnot $e330) (bvnot $e331)))
(define-fun $e333 () (_ BitVec 1) (bvand $e15 (bvnot $e308)))
(define-fun $e334 () (_ BitVec 1) (bvand (bvnot $e15) (bvnot $e332)))
(define-fun $e335 () (_ BitVec 1) (bvand (bvnot $e333) (bvnot $e334)))
(define-fun $e336 () (_ BitVec 1) (bvand $e14 (bvnot $e308)))
(define-fun $e337 () (_ BitVec 1) (bvand (bvnot $e14) (bvnot $e335)))
(define-fun $e338 () (_ BitVec 1) (bvand (bvnot $e336) (bvnot $e337)))
(define-fun $e339 () (_ BitVec 1) (bvand $e13 (bvnot $e308)))
(define-fun $e340 () (_ BitVec 1) (bvand (bvnot $e13) (bvnot $e338)))
(define-fun $e341 () (_ BitVec 1) (bvand (bvnot $e339) (bvnot $e340)))
(define-fun $e342 () (_ BitVec 1) (bvand $e12 (bvnot $e308)))
(define-fun $e343 () (_ BitVec 1) (bvand (bvnot $e12) (bvnot $e341)))
(define-fun $e344 () (_ BitVec 1) (bvand (bvnot $e342) (bvnot $e343)))
(define-fun $e345 () (_ BitVec 1) (bvand $e11 (bvnot $e311)))
(define-fun $e346 () (_ BitVec 1) (bvand (bvnot $e11) (bvnot $e344)))
(define-fun $e347 () (_ BitVec 1) (bvand (bvnot $e345) (bvnot $e346)))
(define-fun $e348 () (_ BitVec 1) (bvand stbusy_1 $e9))
(define-fun $e349 () (_ BitVec 1) (bvand (bvnot $e9) (bvnot $e347)))
(define-fun $e350 () (_ BitVec 1) (bvand reset_1 stbusy_1))
(define-fun $e351 () (_ BitVec 1) (bvand (bvnot reset_1) $e349))
(define-fun $e352 () (_ BitVec 1) (bvand (bvnot reset_1) $e135))
(assert (not (= (bvnot $e350) #b0)))
...
(assert (not (= (bvnot $e351) #b0)))
(assert (not (= (bvnot $e352) #b0)))
(assert (not (= (bvnot $e134) #b0)))
(assert (not (= (bvnot $e348) #b0)))
(check-sat)
(exit)
