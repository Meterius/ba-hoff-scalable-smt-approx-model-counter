...
(define-fun $e61 () (_ BitVec 1) (bvand sflashclock1_1 $e58))
(define-fun $e62 () (_ BitVec 1) (bvand $e13 $e61))
(define-fun $e63 () (_ BitVec 1) (bvand rst_1 (bvnot $e62)))
(define-fun $e64 () (_ BitVec 1) (bvand (bvnot rst_1) (bvnot $e60)))
(define-fun $e65 () (_ BitVec 1) (bvand (bvnot $e63) (bvnot $e64)))
(define-fun $e66 () (_ BitVec 1) (bvand $e10 (bvnot $e65)))
(define-fun $e67 () (_ BitVec 1) (bvand (bvnot $e10) (bvnot $e60)))
(define-fun $e68 () (_ BitVec 1) (bvand (bvnot $e66) (bvnot $e67)))
(define-fun $e69 () (_ BitVec 1) (bvand (bvnot clk_1) $e59))
(define-fun $e70 () (_ BitVec 1) (ite (= count1_0 (bvnot $e1)) #b1 #b0))
(define-fun $e71 () (_ BitVec 1) (ite (= count1_1 $e1) #b1 #b0))
(define-fun $e72 () (_ BitVec 1) (ite (= $e1 $e26) #b1 #b0))
(define-fun $e73 () (_ BitVec 1) (bvand sflashclock1_2 $e72))
(define-fun $e74 () (_ BitVec 1) (bvand rst_2 (bvnot $e73)))
(define-fun $e75 () (_ BitVec 1) (bvand (bvnot $e40) $e72))
(define-fun $e76 () (_ BitVec 1) (bvand (bvnot $e49) (bvnot $e72)))
(define-fun $e77 () (_ BitVec 1) (bvand (bvnot $e75) (bvnot $e76)))
(define-fun $e78 () (_ BitVec 1) (bvand (bvnot rst_2) (bvnot $e77)))
(define-fun $e79 () (_ BitVec 1) (bvand (bvnot $e74) (bvnot $e78)))
(define-fun $e80 () (_ BitVec 1) (bvand $e22 (bvnot $e79)))
(define-fun $e81 () (_ BitVec 1) (bvand (bvnot $e31) $e72))
(define-fun $e82 () (_ BitVec 1) (bvand (bvnot $e25) (bvnot $e81)))
(define-fun $e83 () (_ BitVec 1) (bvand (bvnot $e37) (bvnot $e82)))
(define-fun $e84 () (_ BitVec 1) (bvand (bvnot $e22) (bvnot $e83)))
(define-fun $e85 () (_ BitVec 1) (bvand (bvnot $e80) (bvnot $e84)))
(define-fun $e86 () (_ BitVec 1) (bvand (bvnot $e19) $e85))
(define-fun $e87 () (_ BitVec 1) (bvand $e16 $e86))
(define-fun $e88 () (_ BitVec 1) (bvand $e71 $e87))
(define-fun $e89 () (_ BitVec 1) (ite (= (bvnot $e1) $e12) #b1 #b0))
(define-fun $e90 () (_ BitVec 1) (bvand $e59 $e89))
(define-fun $e91 () (_ BitVec 1) (bvand $e70 (bvnot $e88)))
(define-fun $e92 () (_ BitVec 1) (bvand (bvnot $e70) (bvnot $e90)))
(define-fun $e93 () (_ BitVec 1) (bvand (bvnot $e91) (bvnot $e92)))
(define-fun $e94 () (_ BitVec 1) (bvand clk_1 $e93))
(define-fun $e95 () (_ BitVec 1) (bvand $e13 (bvnot $e69)))
(define-fun $e96 () (_ BitVec 1) (bvand (bvnot $e13) (bvnot $e94)))
(define-fun $e97 () (_ BitVec 1) (bvand (bvnot $e95) (bvnot $e96)))
(define-fun $e98 () (_ BitVec 1) (bvand (bvnot rst_1) (bvnot $e97)))
(define-fun $e99 () (_ BitVec 1) (bvand (bvnot $e63) (bvnot $e98)))
(define-fun $e100 () (_ BitVec 1) (bvand $e7 (bvnot $e99)))
(define-fun $e101 () (_ BitVec 1) (bvand (bvnot $e7) (bvnot $e68)))
(assert (not (= (bvnot $e100) #b0)))
(assert (not (= (bvnot $e101) #b0)))
