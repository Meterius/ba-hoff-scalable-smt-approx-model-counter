...
(declare-fun flashclk2__U2__count1_0 () (_ BitVec 16))
(declare-fun flashclk2__U2__sflashclock2_0 () (_ BitVec 1))
(declare-fun flashclk2__U2__sflashclock2_1 () (_ BitVec 1))
...
(define-fun $e6 () (_ BitVec 1) (ite (= flashclk2__U2__count1_0 (bvnot $e1)) #b1 #b0))
(define-fun $e7 () (_ BitVec 1) (ite (= (bvnot flashclk2__U2__sflashclock2_0) flashclk2__U2__sflashclock2_1) #b1 #b0))
(define-fun $e8 () (_ BitVec 1) (ite (= flashclk2__U2__sflashclock2_0 flashclk2__U2__sflashclock2_1) #b1 #b0))
...
(define-fun $e15 () (_ BitVec 1) (bvand flashclk2__U2__sflashclock2_1 rset_1))
(define-fun $e16 () (_ BitVec 1) (bvand (bvnot rset_1) (bvnot $e14)))
(define-fun $e17 () (_ BitVec 1) (bvand $e4 (bvnot $e8)))
(define-fun $e18 () (_ BitVec 1) (bvand (bvnot $e4) $e15))
(assert (not (= (bvnot $e17) #b0)))
